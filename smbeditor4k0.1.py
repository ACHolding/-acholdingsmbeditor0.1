...
6502/NES test play uses a 60 FPS display loop scaffold; full CPU/PPU execution is intentionally ROM-safe and not bundled with copyrighted game data.
...
APP_VERSION = "1.08 (Python 3.14 port 0.4)"
...
# Complete 256-byte NMOS 6502 opcode lookup.
# Official opcodes use their common mnemonic + addressing mode. Undocumented
# opcodes are still listed by byte so tools can display every value found in
# SMB1 data/code without crashing.
ADDRESSING_MODE = {
    "IMP": "implied", "ACC": "accumulator", "IMM": "immediate",
    "ZP": "zero page", "ZPX": "zero page,X", "ZPY": "zero page,Y",
    "REL": "relative", "ABS": "absolute", "ABX": "absolute,X",
    "ABY": "absolute,Y", "IND": "indirect", "IZX": "(indirect,X)",
    "IZY": "(indirect),Y", "UND": "undocumented",
}

_OPCODE_ROWS = [
    ("BRK","IMP"),("ORA","IZX"),("KIL","UND"),("SLO","UND"),("NOP","UND"),("ORA","ZP"),("ASL","ZP"),("SLO","UND"),("PHP","IMP"),("ORA","IMM"),("ASL","ACC"),("ANC","UND"),("NOP","UND"),("ORA","ABS"),("ASL","ABS"),("SLO","UND"),
    ("BPL","REL"),("ORA","IZY"),("KIL","UND"),("SLO","UND"),("NOP","UND"),("ORA","ZPX"),("ASL","ZPX"),("SLO","UND"),("CLC","IMP"),("ORA","ABY"),("NOP","UND"),("SLO","UND"),("NOP","UND"),("ORA","ABX"),("ASL","ABX"),("SLO","UND"),
    ("JSR","ABS"),("AND","IZX"),("KIL","UND"),("RLA","UND"),("BIT","ZP"),("AND","ZP"),("ROL","ZP"),("RLA","UND"),("PLP","IMP"),("AND","IMM"),("ROL","ACC"),("ANC","UND"),("BIT","ABS"),("AND","ABS"),("ROL","ABS"),("RLA","UND"),
    ("BMI","REL"),("AND","IZY"),("KIL","UND"),("RLA","UND"),("NOP","UND"),("AND","ZPX"),("ROL","ZPX"),("RLA","UND"),("SEC","IMP"),("AND","ABY"),("NOP","UND"),("RLA","UND"),("NOP","UND"),("AND","ABX"),("ROL","ABX"),("RLA","UND"),
    ("RTI","IMP"),("EOR","IZX"),("KIL","UND"),("SRE","UND"),("NOP","UND"),("EOR","ZP"),("LSR","ZP"),("SRE","UND"),("PHA","IMP"),("EOR","IMM"),("LSR","ACC"),("ALR","UND"),("JMP","ABS"),("EOR","ABS"),("LSR","ABS"),("SRE","UND"),
    ("BVC","REL"),("EOR","IZY"),("KIL","UND"),("SRE","UND"),("NOP","UND"),("EOR","ZPX"),("LSR","ZPX"),("SRE","UND"),("CLI","IMP"),("EOR","ABY"),("NOP","UND"),("SRE","UND"),("NOP","UND"),("EOR","ABX"),("LSR","ABX"),("SRE","UND"),
    ("RTS","IMP"),("ADC","IZX"),("KIL","UND"),("RRA","UND"),("NOP","UND"),("ADC","ZP"),("ROR","ZP"),("RRA","UND"),("PLA","IMP"),("ADC","IMM"),("ROR","ACC"),("ARR","UND"),("JMP","IND"),("ADC","ABS"),("ROR","ABS"),("RRA","UND"),
    ("BVS","REL"),("ADC","IZY"),("KIL","UND"),("RRA","UND"),("NOP","UND"),("ADC","ZPX"),("ROR","ZPX"),("RRA","UND"),("SEI","IMP"),("ADC","ABY"),("NOP","UND"),("RRA","UND"),("NOP","UND"),("ADC","ABX"),("ROR","ABX"),("RRA","UND"),
    ("NOP","UND"),("STA","IZX"),("NOP","UND"),("SAX","UND"),("STY","ZP"),("STA","ZP"),("STX","ZP"),("SAX","UND"),("DEY","IMP"),("NOP","UND"),("TXA","IMP"),("XAA","UND"),("STY","ABS"),("STA","ABS"),("STX","ABS"),("SAX","UND"),
    ("BCC","REL"),("STA","IZY"),("KIL","UND"),("AHX","UND"),("STY","ZPX"),("STA","ZPX"),("STX","ZPY"),("SAX","UND"),("TYA","IMP"),("STA","ABY"),("TXS","IMP"),("TAS","UND"),("SHY","UND"),("STA","ABX"),("SHX","UND"),("AHX","UND"),
    ("LDY","IMM"),("LDA","IZX"),("LDX","IMM"),("LAX","UND"),("LDY","ZP"),("LDA","ZP"),("LDX","ZP"),("LAX","UND"),("TAY","IMP"),("LDA","IMM"),("TAX","IMP"),("LAX","UND"),("LDY","ABS"),("LDA","ABS"),("LDX","ABS"),("LAX","UND"),
    ("BCS","REL"),("LDA","IZY"),("KIL","UND"),("LAX","UND"),("LDY","ZPX"),("LDA","ZPX"),("LDX","ZPY"),("LAX","UND"),("CLV","IMP"),("LDA","ABY"),("TSX","IMP"),("LAS","UND"),("LDY","ABX"),("LDA","ABX"),("LDX","ABY"),("LAX","UND"),
    ("CPY","IMM"),("CMP","IZX"),("NOP","UND"),("DCP","UND"),("CPY","ZP"),("CMP","ZP"),("DEC","ZP"),("DCP","UND"),("INY","IMP"),("CMP","IMM"),("DEX","IMP"),("AXS","UND"),("CPY","ABS"),("CMP","ABS"),("DEC","ABS"),("DCP","UND"),
    ("BNE","REL"),("CMP","IZY"),("KIL","UND"),("DCP","UND"),("NOP","UND"),("CMP","ZPX"),("DEC","ZPX"),("DCP","UND"),("CLD","IMP"),("CMP","ABY"),("NOP","UND"),("DCP","UND"),("NOP","UND"),("CMP","ABX"),("DEC","ABX"),("DCP","UND"),
    ("CPX","IMM"),("SBC","IZX"),("NOP","UND"),("ISC","UND"),("CPX","ZP"),("SBC","ZP"),("INC","ZP"),("ISC","UND"),("INX","IMP"),("SBC","IMM"),("NOP","IMP"),("SBC","UND"),("CPX","ABS"),("SBC","ABS"),("INC","ABS"),("ISC","UND"),
    ("BEQ","REL"),("SBC","IZY"),("KIL","UND"),("ISC","UND"),("NOP","UND"),("SBC","ZPX"),("INC","ZPX"),("ISC","UND"),("SED","IMP"),("SBC","ABY"),("NOP","UND"),("ISC","UND"),("NOP","UND"),("SBC","ABX"),("INC","ABX"),("ISC","UND"),
]
CPU_6502_OPCODES: tuple[tuple[str, str], ...] = tuple(_OPCODE_ROWS)
...
class SMBUtility:
    ...
    def create_main_layout(self) -> None:
        ...
        tabs = [
            ...
            ("6502 Opcodes", self._build_opcode_table_tab),
    ...
    def _build_emulator_tab(self, tab: tk.Frame) -> None:
        ...
        self._hint(tab, "60 FPS NES-speed display loop scaffold with full 256-byte 6502 opcode reference.")
    ...
    def _build_opcode_table_tab(self, tab: tk.Frame) -> None:
        self._section_label(tab, "6502 Opcode Table")
        self._hint(tab, "All 256 opcode byte values are listed; undocumented NMOS 6502 opcodes are marked.")
        cols = ("hex", "mnemonic", "mode")
        self.opcode_tree = ttk.Treeview(tab, columns=cols, show="headings", height=20)
        for col, title, width in (("hex", "Hex", 70), ("mnemonic", "Mnemonic", 120), ("mode", "Addressing mode", 220)):
            self.opcode_tree.heading(col, text=title)
            self.opcode_tree.column(col, width=width, anchor="w")
        self.opcode_tree.pack(fill="both", expand=True, padx=12, pady=8)
        for op, (mnemonic, mode) in enumerate(CPU_6502_OPCODES):
            label = ADDRESSING_MODE.get(mode, mode)
            if mode == "UND":
                label = f"undocumented / {mnemonic}"
            self.opcode_tree.insert("", "end", values=(f"${op:02X}", mnemonic, label))
    ...
    def _emu_action(self, action: str) -> None:
        ...
        if not self.rom_data and action != "Stop":
        ...
        if action == "Stop":
            ...
            self._set_status("Emulator stopped.")

            if self.emu_canvas:
                self.emu_canvas.delete("all")
                self.emu_canvas.create_text(256, 240, text="NES display\n(stopped)", fill=self.muted, font=("Consolas", 12), justify="center")

            return

        self.emu_running = True

        self.emu_frame_count = 0

        self._set_status(f"Emulator: {action} @ 60 FPS display timing")

        self._refresh_emu_frame()



    def _refresh_emu_frame(self) -> None:

        if not self.emu_running:

            return

        self.emu_frame_count += 1

        self._draw_emulator_frame()

        self.root.after(self.emu_fps_ms, self._refresh_emu_frame)



    def _draw_emulator_frame(self) -> None:

        if not self.emu_canvas:

            return

        self.emu_canvas.delete("all")

        w, h = int(self.emu_canvas["width"]), int(self.emu_canvas["height"])

        # Blue-hue placeholder display that runs at NES-like 60 FPS timing.
        self.emu_canvas.create_rectangle(0, 0, w, h, fill="#001122", outline="")

        for x in range(0, w, 16):
            shade = "#002244" if (x // 16 + self.emu_frame_count) % 2 else "#003366"
            self.emu_canvas.create_rectangle(x, 0, x + 16, h, fill=shade, outline="")

        self.emu_canvas.create_text(
            w // 2,
            h // 2 - 18,
            text="NES 60 FPS display loop",
        ...
        self.emu_canvas.create_text(
            w // 2,
            h // 2 + 12,
            text=f"Frame {self.emu_frame_count}  |  6502 opcodes loaded: {len(CPU_6502_OPCODES)}",
            fill=self.muted,
            font=("Consolas", 10),
        )
